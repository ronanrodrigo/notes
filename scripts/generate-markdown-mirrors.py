...
def render_sitemap(posts: list[tuple[str, dict[str, str | list[str]], str]]) -> str:
    lines = [
        ...
        f"- [Sobre]({BASE_URL}/about/): quem mantém o Notes e como entrar em contato.",
        f"- [Contato]({BASE_URL}/contact/): canais para falar com Ronan.",
        f"- [Privacidade]({BASE_URL}/privacy/): como o site trata dados de visitantes.",
        "",
        "## Notas",
        "",
    ]
