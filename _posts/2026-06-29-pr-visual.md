...
date: "2026-06-29"
description: 'Procedimentos para adicionar evidências visuais a pull requests sem versionar arquivos binários.'
---
...
- Gravação via CLI: [Acesse aqui](https://docs.maestro.dev/maestro-flows/workspace-management/record-your-flow.md?displayAgentInstructions=true)

- startRecording (in-flow): [Acesse aqui](https://docs.maestro.dev/reference/commands-available/startrecording.md?displayAgentInstructions=true)

- stopRecording (in-flow): [Acesse aqui](https://docs.maestro.dev/reference/commands-available/stoprecording.md?displayAgentInstructions=true)
...
- No markdown final do PR, use **apenas** URLs hospedadas pelo GitHub: [Acesse aqui](https://github.com/user-attachments/assets/)...
...
- [ ] A URL do vídeo começa com [Acesse aqui](https://github.com/user-attachments/assets/)
- [ ] Todo <img> usa URL [Acesse aqui](https://github.com/user-attachments/assets/)
