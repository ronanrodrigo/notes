...
- **~1,6B tokens gratuitos/mês** (até 2,1B no primeiro mês)
- **Compressão RTK+Caveman** economiza 15-95% de tokens
- **Auto-fallback** automático entre provedores
- **MIT Licensed** - código aberto e hospedado localmente
- **Sem billing** - você paga diretamente aos provedores
